...
namespace mf_dev_backend_2025.Controllers
{
    ...
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,descricao,Data,Valor,km,tipoCombustivel,VeiculoId")] Consumo consumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,descricao,Data,Valor,km,tipoCombustivel,VeiculoId")] Consumo consumo)
        {
            if (id != consumo.id)
            {
                return NotFound();
